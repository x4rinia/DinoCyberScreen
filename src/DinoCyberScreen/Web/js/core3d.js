let canvas,gl,program,pointBuffer,lineBuffer,pointCount=0,lineCount=0,start=performance.now(),quality='High',fps=60,lastFrame=0,intensity=.4,lineColor=[.15,.85,1],pointColor=[.25,1,.75];
...
const THEME_COLORS = {
  ...
  rainbow: { primary: [1.0, .23, .36],  secondary: [1.0, .52, .20]  },  // starts red, animates in JS
};
