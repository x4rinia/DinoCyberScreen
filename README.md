...
- **Holographic Core Specimens:** Choose between **Ankylosaurus (Standard)**, **Triceratops**, and **Velociraptor** as your central 3D wireframe hologram display.
- **Custom Color Profiles:** Select from 4 curated Cyberpunk color themes:
...
- **Interactive Mouse Handling:** Mouse cursor stays hidden on launch and remains comfortably visible whenever moved.
